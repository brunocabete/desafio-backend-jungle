...
| 8 — Documentation & final pass | ✅ item 1 (`README.md` reescrito) e item 3 (suíte verde — unit 231, e2e 70; §14 sem falha eliminatória). Item 2: **`ARCHITECTURE.md` reescrito** (estrutura textual enxuta, 2 diagramas, decisões §1–§30 consolidadas; sem disclaimer de IA) cobrindo as exigências explícitas da SPECS (ORM/Money/transação §4, concorrência §8, transições/failure codes/payloadHash §7/§9, auth §2, trade-offs/limitações §14). |
